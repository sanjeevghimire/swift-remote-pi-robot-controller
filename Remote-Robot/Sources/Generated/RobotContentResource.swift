...
public class RobotContentResource {
    private let adapter: RobotContentAdapter
    private let path = "/api/RobotContents"
    private let pathWithID = "/api/RobotContents/:id"

    init(factory: AdapterFactory) throws {
        adapter = try factory.getRobotContentAdapter()
    }
